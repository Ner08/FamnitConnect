        ...
        <Grid key={data.id} item xs={12} sm={12} md={6} lg={3} xl={2}>
          <div className={classes.paper}>
            <Button onClick={() => window.open(data.url, "_blank")} className={classes.button}>
              <Typography style={{ position: "absolute", right: -7, top: -7, backgroundColor: "green", borderRadius: 50, paddingLeft: 9, paddingRight: 9, paddingtop: 2, paddingBottom: 2, textAlign: "center" }}>
                {data.likes}
              </Typography>
              <Typography className={classes.facultyClass}>
                {data.name}
              </Typography>
            </Button>
          </div>
